...
var (
	...
	memory                               int64
	sshHost, sshUser, sshPort, regions, listeners string
	subnetId, sgId string
...
`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		// this is unneccesary.  The SDK will check everywhere (config file, env, or associated role)
		// Removing this check allows the app to use instance role credentials
